...
class MajaScan {
  ...
  static const CameraAccessDenied = 'PERMISSION_NOT_GRANTED';
   ...
   static Future<String> startScan({String title = "", bool flashlightEnable = true, Color barColor, Color titleColor}) async {
   int flashlight = (flashlightEnable ? 1 : 0);

   Map<String, String> scanArgs = {
      ScanArgs.TITLE: title,
      ScanArgs.FLASHLIGHT:flashlight.toString(),
      ScanArgs.BAR_COLOR:'#${barColor.value.toRadixString(16)}',
      ScanArgs.TITLE_COLOR:'#${titleColor.value.toRadixString(16)}'
    };
